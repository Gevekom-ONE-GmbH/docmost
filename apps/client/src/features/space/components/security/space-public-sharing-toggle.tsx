...
/**
 * Clean-room (non-EE) toggle to disable public sharing for a space.
 * Backend + enforcement live in the AGPL core (space.service writes
 * settings.sharing.disabled); this only drives the core /spaces/update call.
 */
      ...
      children: (
        <Text size="sm">
          {value
            ...
            : t("Are you sure you want to enable public sharing for this space?")}
        </Text>
      ),
      centered: true,
